            ...
            <div className="container">
                <div className="s_bode">
                    <div className="left_section">
                        <img src={"https://footium.club/beta/api/nfts/clubs/" + data.clubFixtures[0].club.id + "/image.svg"} alt=""></img>
                    ...
                    <div className="right_section">
                        <img src={"https://footium.club/beta/api/nfts/clubs/" + data.clubFixtures[1].club.id + "/image.svg"} alt=""></img>
